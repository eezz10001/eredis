...
## 1 Fork 代码
1. 访问 https://github.com/eezz10001/eredis
...
```bash
git clone https://github.com/eezz10001/eredis.git
cd eredis
git remote add upstream 'git@github.com:<your github username>/eredis.git'
```
...
## 6 提交 PR
访问 https://github.com/eezz10001/eredis, 
